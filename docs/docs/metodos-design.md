...
| **Jornada do Usuário** | A experiência cronológica do usuário (Macro). | [Veja nosso guia detalhado aqui](./user-flow-journey). |
| **Service Blueprint** | Os bastidores operacionais do serviço. | [Veja nosso guia detalhado aqui](./service-blueprint). |
